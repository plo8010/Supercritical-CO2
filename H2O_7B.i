...
[Kernels]
  ...
  [flux_water]
    ...
    fluid_component = 0
    variable = pwater
    #gravity = '0 -9.81 0' # adding gravity in MPa 
  []
  [mass_co2_dot]
    type = PorousFlowMassTimeDerivative
    fluid_component = 1
...
[DiracKernels] # Point source and point sink code/elements
  [fluid_injection]
    point = '400 525 0'
    mass_flux = 6.7E-3
    variable = pwater #variable changed from sgas to pwater for water case
